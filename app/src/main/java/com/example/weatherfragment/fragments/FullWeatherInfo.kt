...
class FullWeatherInfo: Fragment() {
    ...
    private lateinit var fullWeatherInfoTextView: TextView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            try {
                ...
                fullWeatherInfoTextView = view.findViewById(R.id.fullWeatherInfoTextView)
                ...
                requireActivity().runOnUiThread {
                    fullWeatherInfoTextView.text = fullWeatherInfoText
                    fullWeatherInfoTextView.textSize = 20f
                }
            } catch (e: IOException) {
                e.printStackTrace()
            }
